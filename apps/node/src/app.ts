...
import { ApiBootstrap, ApiEnvCheck, ApiSetupConfig, ApiUpdateStableDiffusionConfig, ApiRestartComfyUI, ApiUpdateComfyUIAndRestart, ApiGetCondaInfo, ApiFPModeSetupConfig, ApiVAEModeSetupConfig } from './routes/api/bootstrap';
...
export async function startAppServer(params: {
  ...
  app.post('/api/fpmode_setup_config', ApiFPModeSetupConfig);
  app.post('/api/vaemode_setup_config', ApiVAEModeSetupConfig);
